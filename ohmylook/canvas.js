...
var particles = [];
var pink_color_r = 255;
var pink_color_g = 226;
var pink_color_b = 229;
var white_color_r = 103;
var white_color_g = 88;
var white_color_b = 76;
var blue_color_r = 136;
var blue_color_g = 208;
var blue_color_b = 200;
...
$(document).ready(function () {
    ...
    canvas.height = H;
	var tmp;
	var col = "rgba(" + pink_color_r + ", " + pink_color_g + ", " + pink_color_b + ", 1)";
    for (var i = 0; i < mp; i++) {
	/*tmp = randomFromTo(1, 3);
	//"rgba(" + Math.floor((Math.random() * 255)) + ", " + Math.floor((Math.random() * 255)) + ", " + Math.floor((Math.random() * 255)) + ", 0.7)"
	if ( tmp == 1)
		col = "rgba(" + pink_color_r + ", " + pink_color_g + ", " + pink_color_b + ", 0.7)"
    else if ( tmp ==2)
		col = "rgba(" + white_color_r + ", " + white_color_g + ", " + white_color_b + ", 0.7)"
	else if ( tmp ==3)
		col = "rgba(" + blue_color_r + ", " + blue_color_g + ", " + blue_color_b + ", 0.7)"*/
        particles.push({
